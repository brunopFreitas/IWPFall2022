...
<form action="editPage.php" method="post" id="form" <?php if ($showFormFlag==false){?>style="display:none"<?php } ?>>
    ...
    <p>Birthdate: <input type="text" name="birthDate" id="birthDate" status="false" value="<?php if ($row){echo $row['birth_date'];}?>"></p>
    <p>First Name: <input type="text" name="firstName" id="firstName" status="false" value="<?php if ($row){echo $row['first_name'];}?>"></p>
    <p>Last Name: <input type="text" name="lastName" id="lastName" status="false" value="<?php if ($row){echo $row['last_name'];}?>"></p>
    <p>Gender: <input type="text" name="gender" id="gender" status="false" value="<?php if ($row){echo $row['gender'];}?>"></p>
    <p>Hire Date: <input type="text" name="hireDate" id="hireDate" status="false" value="<?php if ($row){echo $row['hire_date'];}?>"></p>
